...
pub fn file_size(port: &mut SerialPort, buf: &[u8]) -> Result<(), String> {
...
pub fn file_data(port: &mut SerialPort, data: &[u8]) {
...
pub fn receive_byte(port: &mut SerialPort) -> Result<u8, String> {
...
pub mod r#async {
    ...
    pub async fn send_midi_file_async(port: &mut SerialPort, buf: &[u8]) -> Result<(), String> {
